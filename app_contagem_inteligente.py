...
<div style='border-left: 6px solid #2196F3; background-color: #f0f8ff; padding: 16px; border-radius: 6px;'>
  ...
  <pre style='background-color:#e8f4fd; padding:4px; border-radius:4px;margin-bottom: 8px'>25/09/2023;Aluno;Trabalhar em grupo;2º Ciclo;6º Ano;A;Tempo Livre</pre>
</div>
""", unsafe_allow_html=True)
