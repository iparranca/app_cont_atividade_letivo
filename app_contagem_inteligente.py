...
# Separador
st.markdown("<p style='font-size:20px; font-weight:bold;margin-bottom: 20px;margin-bottom: 0,2px;color:#0056b3;'>Selecione o separador do teu CSV:</p>", unsafe_allow_html=True)
sep = st.selectbox(
    "",
